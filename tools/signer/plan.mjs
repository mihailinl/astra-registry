...
//   list:      git rev-list --count <sha> -- tools/revocations   + 1
//
...
import { buildRevocations } from "../lib/revocations.mjs";
...
export function serialsAt({ root, sha }) {
  return {
    ...
    revocations: revCount({ root, sha, pathspec: "tools/revocations" }) + 1,
  };
}
